<?php
	...
	if($email_existe){
		...
		header('Location: almas.php?'.$retorno_get);
		die();
	}
	...
	if(mysqli_query($link, $sql)){		
		header('Location: almas.php');//ideia, ir pra um site mostrando que sua alma ja fio cadastrada e que esse site tenha um botão q mande de volta pra página almas
	}else{
